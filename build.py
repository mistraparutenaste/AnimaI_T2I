...
CATEGORY_NAMES = {
    ...
    "hair": "髪",
    "situation": "シチュエーション",
    "clothing_real": "服装 - リアル",
    "clothing_fantasy": "服装 - ファンタジー",
    "accessories": "アクセサリー",
    "background": "背景",
    "effect": "効果",
    "rating": "レーティング",
...
SFW_ORDER = [
    ...
    "effect", "art_style", "quality", "era", "rating",
    "my_custom_weapons",
]
NSFW_ORDER = [
...
SLOT_BY_CATEGORY = {
    ...
    "clothing_real": "clothing",
    "clothing_fantasy": "clothing",
    "accessories": "clothing",
    "background": "background",
    "effect": "effect",
    "my_custom_weapons": "clothing",
    # NSFW
    "n_nsfw": "rating_adj",
